...
# 加载和预处理数据
dataset_df = pd.read_csv('./waimai_10k.csv', sep=',', header=0)
...
training_args = TrainingArguments(
    output_dir='./bert-finetuned-use-trainer',  # 训练输出目录，用于保存模型和状态
...
if best_model_path:
    ...
    torch.save(best_model.state_dict(), './bert-finetuned-use-trainer/bert.pt')
